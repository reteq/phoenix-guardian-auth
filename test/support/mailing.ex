defmodule PhoenixGuardianAuth.TestMailing do
  @behaviour PhoenixTokenAuth.MailingBehaviour

  def welcome_subject(user, _conn), do: "Hello #{user.account}"
  ...
  def password_reset_subject(user, _conn), do: "Hello #{user.account}"
